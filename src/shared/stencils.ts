...
const STENCILS: readonly Stencil[] = [
  {
    ...
    rules: [
      ...
      "Keep open questions or risks in their own section, not interleaved with the steps - see design_baseline's patterns for the reusable open-questions pattern (issue #114) this rule is the original case of.",
  ...
  },
  {
    ...
    rules: [
      ...
      "If some criteria are genuinely undecided rather than scored (pending more input, blocked on a dependency), list them in their own open-questions section using `design_baseline`'s pattern (issue #114) instead of leaving blank/tentative cells in the table to imply it.",
    ],
    snags: [
  ...
  },
  {
    ...
    rules: [
      ...
      "If open questions remain (root cause suspected but unconfirmed, a fix proposed but not yet decided), give them their own section using `design_baseline`'s open-questions pattern (issue #114) rather than leaving them implicit in the narrative.",
    ],
    snags: [
